    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-xl-10 content ms-auto py-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="mb-0">Tambah Kebiasaan Baru</h2>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <select class="form-select bg-dark border-0 @error('icon') is-invalid @enderror" 
                                    ...
                                    <option value="fas fa-running" {{ old('icon') == 'fas fa-running' ? 'selected' : '' }}>Lari</option>
                                    <option value="fas fa-book" {{ old('icon') == 'fas fa-book' ? 'selected' : '' }}>Baca</option>
                                    <option value="fas fa-utensils" {{ old('icon') == 'fas fa-utensils' ? 'selected' : '' }}>Makan</option>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control bg-dark border-0 @error('target_count') is-invalid @enderror" 
                                       id="target_count" name="target_count" value="{{ old('target_count') }}" min="1" required>
                                @error('target_count')
                                    <div class="invalid-feedback d-block">
                                        {{ $message }}
                                    </div>
