    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-xl-10 ms-sm-auto px-md-4 py-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="h2 text-gradient"><i class="fas fa-piggy-bank me-2"></i>Target Tabungan</h1>
                <a href="{{ route('savings-targets.create') }}" class="btn btn-primary rounded-pill">
            ...
            <div class="row g-4">
                @forelse($savingsTargets as $target)
                    @php
                        ...
                        $progress = min($progress, 100); // Batasi progress maksimal 100%
                    @endphp
                    ...
                    <div class="card bg-dark-2 h-100 shadow-lg">
                        <div class="card-body d-flex flex-column">
                            <div class="d-flex justify-content-between align-items-start mb-3">
                                ...
                                <div class="dropdown">
                                    <button class="btn btn-sm btn-dark" type="button" data-bs-toggle="dropdown"><i class="fas fa-ellipsis-v"></i></button>
